...
const Sidebar = ({ role, children }: SidebarProps) => {
  ...
  return (
    <>
      <Navbar />
      <div className="flex">
        <div className="w-64 bg-gradient-to-b from-white to-cream-50 dark:from-slate-800 dark:to-slate-900 min-h-[calc(100vh-64px)] border-r border-slate-200 dark:border-slate-700 flex flex-col">
